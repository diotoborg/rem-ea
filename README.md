...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@diotoborg/rem-ea">
    <img alt="" src="https://img.shields.io/npm/v/@diotoborg/rem-ea.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@diotoborg/rem-ea.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@diotoborg/rem-ea">
...
There is also a [Changelog](https://github.com/diotoborg/rem-ea/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@diotoborg/rem-ea';
...
```js
const classNames = require('@diotoborg/rem-ea/dedupe');
...
```js
const classNames = require('@diotoborg/rem-ea/bind');
...
import classNames from '@diotoborg/rem-ea/bind';
